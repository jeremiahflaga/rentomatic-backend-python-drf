# [Rentomatic of Leonardo Giordani](http://blog.thedigitalcatonline.com/blog/2016/11/14/clean-architectures-in-python-a-step-by-step-example/) using the Django REST Framework (DRF) 
